# Title: Implement Queue Using List With Enqueue/dequeue/front
# Difficulty: Easy
#
# Description:
# Implement queue using list with enqueue/dequeue/front and return outputs for the required operations.
#
