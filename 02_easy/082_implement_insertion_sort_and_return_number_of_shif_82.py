# Title: Implement Insertion Sort And Return Number Of Shifts
# Difficulty: Easy
#
# Description:
# Implement insertion sort and return number of shifts and return outputs for the required operations.
#
